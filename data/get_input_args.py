...
def get_input_args():
    ...
    parser.add_argument('--arch',type=str, default = 'vgg', help='the default CNN')
    parser.add_argument('--dogfile',type=str, default = 'dognames.txt', help='Dogs file names')
